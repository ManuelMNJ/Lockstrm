// =============================================================================
// Lockstrm — VideosComponent
// Ruta: src/app/features/videos/
// NOTA: El import de VideoService apunta a core/services/ (nueva ubicación).
// La lógica de negocio (validación 95 MB, Cloudinary) permanece intacta.
// =============================================================================
