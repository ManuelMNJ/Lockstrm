 ...
 */
public record GroupVideoStatsDto(
        Long          idVideo,
        String        titulo,
        String        miniaturaUrl,
        Integer       duracion,
     ...
     * {@link #withSparkline}.
     */
    public GroupVideoStatsDto(Long idVideo, String titulo, String miniaturaUrl, Integer duracion,
    ...
    public GroupVideoStatsDto withSparkline(List<Integer> sparkline) {
        return new GroupVideoStatsDto(idVideo, titulo, miniaturaUrl, duracion,
                autorIdUsuario, autorUsername, autorTag,
                visitasTotales, espectadoresUnicos, tiempoTotalSegundos,
                duracionMediaSegundos, porcentajeCompletadoMedio,
